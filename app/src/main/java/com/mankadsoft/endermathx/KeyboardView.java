...
public class KeyboardView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getTag() != null && "number_button".equals(v.getTag())) {
            answer.append(((TextView) v).getText());
            if(AppState.getCurrentGame() != null) {
                AppState.getCurrentGame().logKeyStroke(GameEvent.KEY_STROKE_NUM, Integer.toString(v.getId()));
            }
            return;
        }
        if(AppState.getCurrentGame() != null) {
            AppState.getCurrentGame().logKeyStroke(GameEvent.KEY_STROKE_DEL, Integer.toString(v.getId()));
        }
        switch (v.getId()) {
            ...
            case R.id.t9_key_backspace: { // handle backspace button
                ...
                Editable editable = answer.getText();
